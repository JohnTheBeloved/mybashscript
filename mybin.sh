...
JAVA_HOME=$MANUAL_INSTALL_PATH/java/jdk1.8/jdk1.8.0_31
...
source /home/osboxes/mybashscript/exports.sh

#Load my work init
source /home/osboxes/mybashscript/apps.sh


#Load bin aliases
source /home/osboxes/mybashscript/aliases.sh
